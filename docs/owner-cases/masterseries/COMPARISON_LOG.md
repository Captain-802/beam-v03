...
## Addendum 20 Sep 2026 (evening): flange resistance and the torsion + N / M_z verification in beam-v03
- M_f,Rd for I/H sections is now the flange plastic moment t_f b^2 f_y/4 (SCI P385 3.1.2), 40.255 kN.m for the 457x191 UB 82 - identical to the MasterSeries printouts above (it was M_pl,z/2 = 41.8). Effect: k_w 0.665 -> 0.663 (MasterSeries 0.663), (A.1) UB6-L2 0.890 -> 0.897 standard / 0.897 -> 0.903 eigen (MasterSeries 0.892), P385 3.1.2 0.408 -> 0.415 (MasterSeries local 0.415).
- The "torsion with axial force / imposed M_z: NOT VERIFIED" block is gone: beam-v03 now runs EN 1993-1-1 6.2.7(5) Eq (6.1) at four points of every torsion station (sigma from N, M_y, M_z,tot = M_z + phi.M_y and the bimoment, tau from V, St Venant and warping), EN 1993-6 (A.1) with M_z,tot, and Eq 6.61/6.62 with M_z,tot; the 6.62 + (A.1) superposition is printed as information only (no EN 1993 expression combines N_Ed with warping torsion).
- M_y,Ed >= M_cr (k_alpha unbounded) is reported as a FAIL row (Annex A utilisation 99), no longer as NOT VERIFIED.
