...
mk('TFB-04', 'PFC 300x100x46, 4 m SS, eccentric UDL e = 50 mm + N = 100 kN, restrained - design intent: PASS since 20 Sep 2026 torsion + N/Mz (formerly NOT VERIFIED by the combined torsion + N_Ed block): (6.1) elastic 0.14 (verdict-binding: open section with N_Ed), Eq 6.62 0.35 with M_z,Ed = phi.M_y, 6.3.1.4 at 0.10', PFC('300x100x46'),
...
mk('TOR-01', 'PFC 200x90x30, 2.5 m cantilever, 13 kN tip load at e = 45 mm (flange half-width) + self-weight at e_sc, unrestrained - design intent: PASS (P385 3.1.2 0.72, Annex A 0.98; the cantilever preset restrains the root warping, Annex A 1.09 with it free); the elastic yield criterion (6.1) = 1.29 at the root flange tip (sigma_My + sigma_w = 313 N/mm2) is printed as information with an advisory - Class 1, N_Ed = 0: EN 1993-1-1 6.2.7(6) permits the plastic route (20 Sep 2026 review)', PFC('200x90x30'),
...
mk('TOR-05', 'UB 305x165x40, 3 m cantilever, full UDL at e = 80 mm, unrestrained - design intent: PASS (Annex A 0.62, P385 3.1.2 0.57); the elastic yield criterion (6.1) = 1.14 at the root flange tip (sigma_w = 196 N/mm2 from the fixed-warping bimoment) is printed as information with an advisory - Class 1, N_Ed = 0: 6.2.7(6) plastic route (20 Sep 2026 review); cantilever with a distributed torque: FE with the root warping fixed, SN006a on the standard route', UB('305 x 165 x 40'),
